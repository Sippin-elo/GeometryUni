...
public abstract class ComparableGeometry extends Geometry implements Comparable {
   ...
   /**
    * Compares this Geometry with another one. Throws a <code>RuntimeException</code>
    * if <code>o</code> is not of type Geometry. Otherwise compare two
    * Geometries by their volume.
    *
    * @throws RuntimeException if o is not of type Geometry
